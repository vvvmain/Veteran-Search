  <!-- 2. Industry Search -->
            ...
            </section>  <div class="clear-all-container">
            <button onclick="clearAllResults()" class="clear-all-btn">Clear All Results</button>
        </div>  <div id="industry-results" class="results">
            ...
            document.addEventListener('DOMContentLoaded', async () => {
                ...
                try {
                    ...
                    console.error(error);
                    industrySelect.innerHTML = '<option value="">Error loading industries</option>';  document.getElementById('industry-search-form').addEventListener('submit', async function(e) {
                        e.preventDefault();
